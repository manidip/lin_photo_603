  ...
  <div  class="menu" style="height: 10px; float: right;">
    ...
    <div  class="selection" style="height:575px; margin-top: 8px; float: left; width:230px;background: -moz-linear-gradient(top, #1e5799 0%, #2989d8 50%, #207cca 51%, #7db9e8 100%);">
      ...
      <ul>
        ...
        <div id=mcatlist><ul>
              <li><a href="#" style="color: aqua;">View Categories</a></li>
...
<fieldset>
<table>
        <tr><th>Category Name<th>Action</th></tr>
    <?php
    $sql="SELECT * FROM `categories`";
    $query=mysql_query($sql);
    while($row=mysql_fetch_array($query))
    {
  echo "<tr><td>$row[cat_name]<td><center><a href=viewcat.php?action=delete&did=$row[cat_id]><img src=delete.png height=25px width=25px/></a></center></tr>";
    }
?>
    </table>
</fieldset>
